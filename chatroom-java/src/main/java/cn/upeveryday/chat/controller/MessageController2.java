...
//    MessageService messageService;
    ...
    public void setChatService(MessageService messageService) {
        MessageController2.messageService = messageService;
    }

    //日志对象
    private static final Logger log = LoggerFactory.getLogger(MessageController2.class);
    /**
     * 记录当前在线连接数
    ...
    public void onMessage(String message, Session session, @PathParam("username") String username) {
        log.info("服务器收到用户{}的消息：{}", username, message);
